...
class App extends Component {
  constructor(props) {
    ...
    this.planets.push([0, 0, 40 * 723187500, 1.989e30, 0, 0, 0xb8e691]); // x, z, r, m , vx, vz, color
    this.planets.push([-107920000000, 0, 5.5 * 723187500, 4.867e24, 0, Math.pow(this.G * this.planets[0][3] / 107920000000, 0.5), 0xe6ce91]);
    this.planets.push([-231420000000, 0, 8 * 723187500, 6.39e23, 0, Math.pow(this.G * this.planets[0][3] / 231420000000, 0.5), 0x9f91e6]);
    ...
    return (
      <TopHolder w={this.state.w} h={this.state.h}>
        ...
        {this.state.showing &&
          <Variables>
            <Tips>
              <br/>Press SPACE to pause<br/>Press n to get 3 new planets<br/>Press h to hide clutter
            </Tips>
          </Variables>
        }
      </TopHolder>
